...
/**
 * @extends ServiceEntityRepository<Generator>
 *
...
class GeneratorRepository extends ServiceEntityRepository
{
    ...
    public function add(Generator $entity, bool $flush = false): void
    {
    ...
    public function remove(Generator $entity, bool $flush = false): void
    {
...
//    }
    ...
    public function getAllGeneratorIds() {
        return $this->createQueryBuilder('g')
            ->select(['g.id'])
            ->getQuery()
            ->getResult();
